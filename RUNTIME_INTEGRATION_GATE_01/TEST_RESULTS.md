...
| T16 | P2 hash unchanged | SHA256(hf_batch.py) before == after | BLOCKED: P2 hf_batch.py assente in questo ambiente (nessun hash calcolabile) | 1 | `evidence/T16_p2_hash.json` | FAIL |
...
**Totale: 19/20 PASS · BLOCKED: ['T16'] · FAIL: nessuno**
