...
compatibility: "Python 3.9+ (requisito reale: Path.is_relative_to; verificato su 3.9.6), Git e checkout Creative OS verificato. Nessuna dipendenza Python esterna, nessun provider reale."
metadata:
