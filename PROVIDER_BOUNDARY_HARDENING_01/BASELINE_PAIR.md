...
| `Frantonaccio/esercitazioni` | `claude/provider-boundary-hardening-c1k77q` | `9aafe9b16f10861846ec7527191009c6e0dabbd6` (commit del codice + evidenza; il commit successivo aggiunge solo MANIFEST.json e SHA256SUMS) | Runtime candidato di questa fase, discende da `39c82968` |
