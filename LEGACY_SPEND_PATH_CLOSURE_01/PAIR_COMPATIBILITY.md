...
| **candidate CORE** | `Frantonaccio/creative-os` | `harden/legacy-spend-core-2026-09-18` | `44f9ea29cea112dfb30c752e5519498e25044c19` |
| **candidate RUNTIME (code sha)** | `Frantonaccio/esercitazioni` | `claude/legacy-spend-path-closure-c50coy` | `ad2f9c072b2a775637eb0b0da0aeca1cb82ca770` |
...
Per questo il pin si e' spostato su `44f9ea29`, e `9cf9cee1` e' entrato in
`KNOWN_STALE_CORE_SHAS`: un Core a quello SHA non e' sconosciuto, e' **vecchio**, e va
